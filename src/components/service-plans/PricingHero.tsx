...
const PricingHero = () => {
  return <section className="bg-gradient-to-r from-[#d76512] to-[#f5a20a] text-white py-16">
      <div className="container-tennessine">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-center">Compare os planos de serviço da Tennessine</h1>
